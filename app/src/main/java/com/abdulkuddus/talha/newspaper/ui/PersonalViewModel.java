...
public class PersonalViewModel extends AndroidViewModel {
    ...
    public PersonalViewModel(Application application) {
        ...
        mNewsList = mRepository.getAllNews(News.SOURCES);
    }
    ...
    public void refreshNews() {
        Log.v("ViewModel", "Called refresh news");
        mRepository.forceUpdateNewsAsync(News.SOURCES);
    }
